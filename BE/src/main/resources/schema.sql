...
(
    ...
    updated_at               DATETIME(6) NULL,
    PRIMARY KEY (id),
    UNIQUE KEY uk_session_instructor_start (instructor_membership_id, start_at),
    UNIQUE KEY uk_session_room_start (room_id, start_at),
...
(
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_reservation_session_member (class_session_id, membership_id),
...
(
    ...
    updated_at       DATETIME(6) NULL,
    PRIMARY KEY (id),
    UNIQUE KEY uk_waiting_session_member (class_session_id, membership_id),
