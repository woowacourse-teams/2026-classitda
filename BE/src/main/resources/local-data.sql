...
VALUES (1, 1, 1, 3, 'ACTIVE', DATE_SUB(CURRENT_TIMESTAMP(6), INTERVAL 30 DAY), CURRENT_TIMESTAMP(6), NULL),
       (2, 1, 2, 1, 'ACTIVE', DATE_SUB(CURRENT_TIMESTAMP(6), INTERVAL 30 DAY), CURRENT_TIMESTAMP(6), NULL),
       (3, 1, 3, 2, 'ACTIVE', DATE_SUB(CURRENT_TIMESTAMP(6), INTERVAL 30 DAY), CURRENT_TIMESTAMP(6), NULL),
       (4, 1, 4, 3, 'ACTIVE', DATE_SUB(CURRENT_TIMESTAMP(6), INTERVAL 30 DAY), CURRENT_TIMESTAMP(6), NULL),
       (5, 1, 5, 3, 'ACTIVE', DATE_SUB(CURRENT_TIMESTAMP(6), INTERVAL 30 DAY), CURRENT_TIMESTAMP(6), NULL);
...
-- 회원용 일별 목록은 아래 회차가 생성된 '로컬 DB 초기화 날짜의 다음 날'로 조회한다.
...
VALUES (
           ...
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '10:20:00'),
           'OPENED',
           CURRENT_TIMESTAMP(6),
           NULL
       ),
       (
           ...
           3,
           '리포머 대기 가능',
           '정원이 가득 차면 대기 신청할 수 있는 수업입니다.',
           'GROUP',
           50,
           1,
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '11:00:00'),
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '11:50:00'),
           'OPENED',
           CURRENT_TIMESTAMP(6),
           NULL
       ),
       (
           ...
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '14:50:00'),
           'OPENED',
           CURRENT_TIMESTAMP(6),
           NULL
       ),
       (
           ...
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '17:50:00'),
           'OPENED',
           CURRENT_TIMESTAMP(6),
           NULL
       ),
       (
           ...
           3,
           '리포머 예약 마감',
           '관리자가 예약 접수를 마감한 수업입니다.',
           'GROUP',
           50,
           5,
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '19:00:00'),
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '19:50:00'),
           'CLOSED',
           CURRENT_TIMESTAMP(6),
           NULL
       ),
       (
           ...
           50,
           5,
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '20:30:00'),
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '21:20:00'),
           'CANCELED',
           CURRENT_TIMESTAMP(6),
           NULL
       ),
       (
           ...
           3,
           '체어 입문',
           '선택한 리포머 수강권으로는 조회되지 않는 수업입니다.',
           'GROUP',
           50,
           5,
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '12:30:00'),
           TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '13:20:00'),
           'OPENED',
           CURRENT_TIMESTAMP(6),
           NULL
       );
