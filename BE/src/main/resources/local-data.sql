...
INSERT INTO class_session (id, studio_id, instructor_membership_id, name, description, class_form, duration_minutes, capacity, start_at, end_at, status, created_at, updated_at)
VALUES (101, 1, 3, '리포머 베이직', '편한 복장과 개인 수건을 준비해 주세요.', 'GROUP', 50, 4, TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '09:30:00'), TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY), '10:20:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       ...
       (108, 1, 3, '완료된 내 리포머 수업', '강사용 달력 완료 집계 확인용 수업입니다.', 'GROUP', 50, 5, TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY), '09:00:00'), TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY), '09:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (109, 1, 2, '완료된 다른 강사 수업', '강사용 달력 내 수업 집계 구분용 수업입니다.', 'GROUP', 50, 5, TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY), '10:30:00'), TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY), '11:20:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (110, 1, 3, '5일 전 출석 리포머', '학생용 달력 출석 표시 확인용 수업입니다.', 'GROUP', 50, 5, TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 5 DAY), '10:00:00'), TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 5 DAY), '10:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (111, 1, 3, '3일 전 출석 리포머', '학생용 달력 출석 표시 확인용 수업입니다.', 'GROUP', 50, 5, TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 3 DAY), '18:00:00'), TIMESTAMP(DATE_SUB(CURRENT_DATE, INTERVAL 3 DAY), '18:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (112, 1, 3, '모레 예약 가능 리포머', '학생용 일별 목록 예약 가능 상태 확인용 수업입니다.', 'GROUP', 50, 4, TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 2 DAY), '15:00:00'), TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 2 DAY), '15:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (113, 1, 3, '3일 후 예약 완료 리포머', '학생용 달력 예약 확정 표시 확인용 수업입니다.', 'GROUP', 50, 5, TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 3 DAY), '10:00:00'), TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 3 DAY), '10:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (114, 1, 3, '4일 후 대기 중 리포머', '학생용 달력 대기 중 표시 확인용 수업입니다.', 'GROUP', 50, 1, TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 4 DAY), '11:00:00'), TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 4 DAY), '11:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (115, 1, 3, '5일 후 예약 완료 리포머', '같은 날짜의 예약 확정과 대기 중 표시 확인용 수업입니다.', 'GROUP', 50, 5, TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 5 DAY), '10:00:00'), TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 5 DAY), '10:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL),
       (116, 1, 3, '5일 후 대기 중 리포머', '같은 날짜의 예약 확정과 대기 중 표시 확인용 수업입니다.', 'GROUP', 50, 1, TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 5 DAY), '18:00:00'), TIMESTAMP(DATE_ADD(CURRENT_DATE, INTERVAL 5 DAY), '18:50:00'), 'OPENED', CURRENT_TIMESTAMP(6), NULL);
...
VALUES (1, 4, 101, NULL, 'RESERVED', CURRENT_TIMESTAMP(6), NULL, CURRENT_TIMESTAMP(6), NULL),
       ...
       (9, 4, 112, NULL, 'RESERVED', CURRENT_TIMESTAMP(6), NULL, CURRENT_TIMESTAMP(6), NULL),
       (10, 5, 112, NULL, 'RESERVED', CURRENT_TIMESTAMP(6), NULL, CURRENT_TIMESTAMP(6), NULL),
       (11, 1, 113, 42, 'RESERVED', CURRENT_TIMESTAMP(6), NULL, CURRENT_TIMESTAMP(6), NULL),
       (12, 4, 114, NULL, 'RESERVED', CURRENT_TIMESTAMP(6), NULL, CURRENT_TIMESTAMP(6), NULL),
       (13, 1, 115, 42, 'RESERVED', CURRENT_TIMESTAMP(6), NULL, CURRENT_TIMESTAMP(6), NULL),
       (14, 4, 116, NULL, 'RESERVED', CURRENT_TIMESTAMP(6), NULL, CURRENT_TIMESTAMP(6), NULL);
