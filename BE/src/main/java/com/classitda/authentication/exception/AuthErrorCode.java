...
public enum AuthErrorCode implements ErrorCode {
    ...
    MEMBER_WITHDRAWAL_PENDING("AUTH-009", "탈퇴 처리 중인 계정입니다.", HttpStatus.FORBIDDEN),
    APPLE_ID_TOKEN_INVALID("AUTH-010", "Apple ID 토큰이 유효하지 않습니다.", HttpStatus.UNAUTHORIZED),
    ...
    VERIFIED_PHONE_UNAVAILABLE("PHONE-008", "인증이 완료된 휴대전화 번호가 없거나 만료되었습니다.", HttpStatus.GONE);
