...
public record ClassSessionUpdateV2Request(
        @Schema(description = "변경할 담당 강사의 시설 소속 ID", example = "12")
    ...
    public static ClassSessionUpdateV2Request of(
            Long instructorMembershipId,
            ClassForm classForm,
            Long classTypeId,
            String className,
        ...
        return new ClassSessionUpdateV2Request(
