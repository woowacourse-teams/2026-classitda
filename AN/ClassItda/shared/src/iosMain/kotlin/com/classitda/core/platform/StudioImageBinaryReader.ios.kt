...
internal actual fun createStudioImageBinaryReader(): StudioImageBinaryReader = IosStudioImageBinaryReader

@OptIn(ExperimentalForeignApi::class)
private object IosStudioImageBinaryReader : StudioImageBinaryReader {
    override suspend fun writeTo(
        ...
        try {
            while (true) {
                ...
                if (count < 0) throw StudioImageBinaryReadException()
                if (count == 0) break
