...
import com.classitda.data.repository.instructor.membership.RemoteInstructorMembershipRepository
...
internal val instructorMemberModule =
    module {
        ...
        single<InstructorMembershipRepository> { RemoteInstructorMembershipRepository(get()) }
    }
