package com.classitda.feature.instructor.management.`class`.util
...
private fun formatPlainTime(time: LocalTime): String =
    "${hour12(time)}:${time.minute.toString().padStart(2, '0')}"
