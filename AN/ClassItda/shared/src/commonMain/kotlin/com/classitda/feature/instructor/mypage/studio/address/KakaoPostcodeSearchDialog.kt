package com.classitda.feature.instructor.mypage.studio.address
...
import classitda.shared.generated.resources.instructor_studio_address_search_close
import classitda.shared.generated.resources.instructor_studio_address_search_description
import classitda.shared.generated.resources.instructor_studio_address_search_error_blocked
import classitda.shared.generated.resources.instructor_studio_address_search_error_network
import classitda.shared.generated.resources.instructor_studio_address_search_error_parse
import classitda.shared.generated.resources.instructor_studio_address_search_error_unknown
import classitda.shared.generated.resources.instructor_studio_address_search_retry
import classitda.shared.generated.resources.instructor_studio_address_search_title
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    Column(
                        ...
                        Row(
                            ...
                            Text(
                                text = stringResource(Res.string.instructor_studio_address_search_title),
                            ...
                            IconButton(onClick = onCancelled) {
                                Icon(
                                    ...
                                    contentDescription =
                                        stringResource(Res.string.instructor_studio_address_search_close),
                                    tint = InsColors.TextSecondary,
                                )
                            }
                        }
                        Text(
                            text = stringResource(Res.string.instructor_studio_address_search_description),
...
private fun KakaoPostcodeErrorContent(
    ...
    val message =
        when (reason) {
            KakaoPostcodeError.NETWORK -> Res.string.instructor_studio_address_search_error_network
            KakaoPostcodeError.INVALID_PAYLOAD -> Res.string.instructor_studio_address_search_error_parse
            KakaoPostcodeError.NAVIGATION_BLOCKED -> Res.string.instructor_studio_address_search_error_blocked
            KakaoPostcodeError.UNKNOWN -> Res.string.instructor_studio_address_search_error_unknown
        }
        ...
        Column(
            ...
            Row(
                ...
                TextButton(onClick = onClose) {
                    Text(stringResource(Res.string.instructor_studio_address_search_close))
                }
                Button(onClick = onRetry, shape = AppShape.Card) {
                    Text(stringResource(Res.string.instructor_studio_address_search_retry))
                }
            }
        }
    }
