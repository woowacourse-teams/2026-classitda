...
import classitda.shared.generated.resources.my_schedule_class_detail_title
...
@Composable
internal fun CompletedClassDetailTopBar(
    onBack: () -> Unit,
    ...
    Surface(
        ...
        Row(
            ...
            Text(
                text = stringResource(Res.string.my_schedule_class_detail_title),
...
@Preview(
    name = "Completed class detail top bar · Student · Default",
    group = "Component/MySchedule",
    showBackground = true,
    widthDp = 390,
)
@Composable
private fun CompletedClassDetailTopBarPreview_Default_Student() {
