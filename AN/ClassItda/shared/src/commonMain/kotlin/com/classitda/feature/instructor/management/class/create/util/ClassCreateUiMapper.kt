package com.classitda.feature.instructor.management.`class`.create.util
...
internal fun List<String>.categoriesOrEmpty(): List<String> = filter { tag -> ClassType.entries.none { it.label == tag } }
